        ...
        elements.detailsContent.innerHTML = `
            <div style="margin-bottom: 24px;">
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 16px;">
                    <div style="width: 56px; height: 56px; border-radius: 50%; background: linear-gradient(135deg, #DC2626, #991B1B); color: white; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 24px;">
                        ${(review.userName || 'A').charAt(0).toUpperCase()}
                    </div>
                    <div>
                        <h3 style="margin: 0; font-size: 20px; color: #1E293B;">${review.userName || 'Anonymous'}</h3>
                ...
                <div style="background: #F8FAFC; padding: 20px; border-radius: 12px; margin-bottom: 16px;">
                    <h4 style="margin: 0 0 12px 0; font-size: 14px; color: #64748B; text-transform: uppercase; font-weight: 600;">Review</h4>
                    <p style="margin: 0; font-size: 15px; color: #1E293B; line-height: 1.7;">${review.review || 'No review text provided'}</p>
                </div>
