...
(function () {
    ...
    window.initializePage = async function () {
        ...
        if (window.hospitalData) {
            state.currentHospitalId = window.hospitalData.id || window.hospitalData.facilityCode || window.hospitalData.hospitalId;
            state.myHospital = window.hospitalData;
        } else {
            // Fallback for super admins or missing data
            state.currentHospitalId = auth.currentUser?.uid;
            state.myHospital = { name: 'Hospital Admin', email: auth.currentUser?.email };
        }
